...
if($_SERVER["REMOTE_ADDR"]==$server_ip || $_SERVER["REMOTE_ADDR"]==$home_ip || $verify_ip) {
    ...
    if (!empty($api_key) && !empty($api_secret)) {
        ...
        $response = $trading_api_sdk->doRequest(TradingApiSdkV4::METHOD_SHOW_ORDERBOOK_COMPACT, [
            TradingApiSdkV4::SHOW_ORDER_BOOK_COMPACT_PARAMETER_TRADING_PAIR     =>      TradingApiSdkV4::TRADING_PAIR_BTCEUR
        ]);
